    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-blue-600 selection:text-white relative overflow-x-hidden pb-0">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-x-2 gap-y-0.5 mt-1.5 text-[9px] md:text-[10px] font-semibold text-slate-600 font-sans">
                <a 
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    handleCopy('+91 99520 77910', 'header1');
                  }} 
                  className="flex items-center gap-1.5 hover:text-[#2563EB] transition-colors whitespace-nowrap cursor-pointer"
                  title="Click to copy +91 99520 77910"
                >
                  <Phone className="w-2.5 h-2.5 text-[#2563EB]" />
                  <span>+91 99520 77910</span>
                  {copiedNumber === 'header1' ? (
                    <Check className="w-2.5 h-2.5 text-emerald-500 scale-110 transition-transform" />
                  ) : (
                    <Copy className="w-2.5 h-2.5 text-slate-400 hover:text-[#2563EB]" />
                  )}
                </a>
                ...
                <a 
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    handleCopy('+91 98946 17232', 'header2');
                  }} 
                  className="flex items-center gap-1.5 hover:text-[#2563EB] transition-colors whitespace-nowrap cursor-pointer"
      ...
      <div id="whatsapp-support-floating" className="fixed bottom-6 right-6 z-50 group flex items-center">
        ...
        <div className="whatsapp-float-wrapper">
          {/* Button Link with Premium Pulse */}
          <a
            ...
            className="w-14 h-14 rounded-full bg-[#25D366] text-white transition-all duration-300 flex items-center justify-center cursor-pointer border border-[#20ba5a]/50 focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2 whatsapp-btn-pulse"
              ...
              <ul className="flex flex-col gap-4">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <a 
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      handleCopy('+91 99520 77910', 'footer1');
                    }}
                    className="text-sm text-slate-400 hover:text-white transition-colors duration-300 leading-relaxed pt-0.5 flex items-center gap-1.5 cursor-pointer"
                    title="Click to copy +91 99520 77910"
                  >
                    <span>+91 99520 77910</span>
                    {copiedNumber === 'footer1' ? (
                      <Check className="w-3.5 h-3.5 text-emerald-400 scale-110 transition-transform" />
                    ) : (
